...
const name = 'tools:test';

const _debug = 'tools:test: errortools:test: warntools:test: log' +
	'tools:test: infotools:test: debug';
const _info = 'tools:test: errortools:test: warntools:test: logtools:test: info';
const _log = 'tools:test: errortools:test: warntools:test: log';
const _warn = 'tools:test: errortools:test: warn';
const _error = 'tools:test: error';
const _no = '';
const _error_c = '%c tools:test %c error';
const _error_con = "\x1b[41m" + "\x1b[37m" + "\x1b[1m" + ' tools:test ' + 
